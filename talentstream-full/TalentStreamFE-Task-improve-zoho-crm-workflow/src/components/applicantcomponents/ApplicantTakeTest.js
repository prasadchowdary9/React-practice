...
import { updateZohoCRM } from './ApplicantBasicDetails'; // Import the function from the ZohoCRM component
...
const ApplicantTakeTest = () => {
  ...
  const handleSubmitTest = () => {
    ...
    if(testName === 'General Aptitude Test' || testName === 'Technical Test'){
     updateZohoCRM(calculatedScore, testStatus); // Update the Zoho CRM with the test result
